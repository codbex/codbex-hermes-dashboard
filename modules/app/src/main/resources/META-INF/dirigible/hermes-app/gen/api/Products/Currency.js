...
var dao = require("codbex-hermes/gen/dao/Products/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/Currency.js/" + entity.Code);
