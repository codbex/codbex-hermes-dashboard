...
var dao = require("codbex-hermes/gen/dao/SalesInvoices/SalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/SalesInvoice.js/" + entity.Id);
