...
var dao = require("hermes-app/gen/dao/SalesInvoices/SalesInvoiceItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/SalesInvoiceItem.js/" + entity.Id);
