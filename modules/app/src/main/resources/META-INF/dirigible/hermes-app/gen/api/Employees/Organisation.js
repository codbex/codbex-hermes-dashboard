...
var dao = require("hermes-app/gen/dao/Employees/Organisation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/Organisation.js/" + entity.Id);
