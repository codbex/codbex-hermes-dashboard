...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'hermes-app.Deliveries.DeliveryStatus.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('hermes-app.Deliveries.DeliveryStatus.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/hermes-app/gen/api/Deliveries/DeliveryStatus.js';
