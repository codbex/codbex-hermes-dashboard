...
var dao = require("hermes-app/gen/dao/Quotations/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/QuotationStatus.js/" + entity.Id);
