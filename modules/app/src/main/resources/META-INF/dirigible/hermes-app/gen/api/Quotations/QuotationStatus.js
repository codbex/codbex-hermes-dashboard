...
var dao = require("codbex-hermes/gen/dao/Quotations/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/QuotationStatus.js/" + entity.Id);
