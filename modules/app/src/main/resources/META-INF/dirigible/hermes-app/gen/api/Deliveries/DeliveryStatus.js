...
var dao = require("hermes-app/gen/dao/Deliveries/DeliveryStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/DeliveryStatus.js/" + entity.Id);
