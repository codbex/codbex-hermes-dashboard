...
var dao = require("codbex-hermes/gen/dao/Opportunities/OpportunityNote");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/OpportunityNote.js/" + entity.Id);
