...
var dao = require("codbex-hermes/gen/dao/Opportunities/OpportunityType");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("OpportunityType not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/OpportunityType.js/" + entity.Id);
