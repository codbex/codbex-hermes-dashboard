...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'hermes-app.Opportunities.OpportunityProbability.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('hermes-app.Opportunities.OpportunityProbability.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/hermes-app/gen/api/Opportunities/OpportunityProbability.js';
