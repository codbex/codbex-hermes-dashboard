...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'hermes-app.Products.ProductGroup.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('hermes-app.Products.ProductGroup.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/hermes-app/gen/api/Products/ProductGroup.js';
