...
const dao = require("hermes-app/gen/dao/Opportunities/OpportunityPriority");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/OpportunityPriority.js/" + entity.Id);
