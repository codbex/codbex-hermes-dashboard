...
var dao = require("hermes-app/gen/dao/Opportunities/OpportunityType");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/OpportunityType.js/" + entity.Id);
