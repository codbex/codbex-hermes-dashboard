...
const dao = require("hermes-app/gen/dao/Opportunities/Opportunity");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/Opportunity.js/" + entity.Id);
