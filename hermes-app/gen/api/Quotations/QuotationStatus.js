...
const dao = require("hermes-app/gen/dao/Quotations/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/QuotationStatus.js/" + entity.Id);
