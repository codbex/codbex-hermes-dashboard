...
const dao = require("hermes-app/gen/dao/SalesInvoices/SalesInvoiceItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/SalesInvoiceItem.js/" + entity.Id);
