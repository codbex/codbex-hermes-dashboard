...
var dao = require("hermes-app/gen/dao/Deliveries/DeliveryEvent");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/DeliveryEvent.js/" + entity.Id);
