...
const dao = require("hermes-app/gen/dao/Deliveries/DeliveryEvent");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/DeliveryEvent.js/" + entity.Id);
