...
const dao = require("hermes-app/gen/dao/Products/ProductGroup");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/ProductGroup.js/" + entity.Id);
