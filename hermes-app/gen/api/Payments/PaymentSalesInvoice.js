...
const dao = require("hermes-app/gen/dao/Payments/PaymentSalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/hermes-app/gen/api/PaymentSalesInvoice.js/" + entity.Id);
