...
var dao = require("hermes-app/gen/dao/Payments/PaymentSalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/hermes-app/gen/api/PaymentSalesInvoice.js/" + entity.Id);
