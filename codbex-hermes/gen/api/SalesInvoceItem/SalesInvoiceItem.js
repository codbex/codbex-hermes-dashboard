...
const dao = require("codbex-hermes/gen/dao/SalesInvoceItem/SalesInvoiceItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/SalesInvoiceItem.js/" + entity.Id);
