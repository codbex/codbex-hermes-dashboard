...
const dao = require("codbex-hermes/gen/dao/SalesOrderItem/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/SalesOrderItem.js/" + entity.Id);
