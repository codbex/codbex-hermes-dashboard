...
var dao = require("codbex-hermes/gen/dao/SalesOrders/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/SalesOrderItem.js/" + entity.Id);
