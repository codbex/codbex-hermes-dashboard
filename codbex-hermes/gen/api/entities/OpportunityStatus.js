...
const dao = require("codbex-hermes/gen/dao/entities/OpportunityStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/OpportunityStatus.js/" + entity.Id);
