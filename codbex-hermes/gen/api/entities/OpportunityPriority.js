...
const dao = require("codbex-hermes/gen/dao/entities/OpportunityPriority");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/OpportunityPriority.js/" + entity.Id);
