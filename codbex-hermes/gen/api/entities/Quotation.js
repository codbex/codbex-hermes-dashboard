...
const dao = require("codbex-hermes/gen/dao/entities/Quotation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/Quotation.js/" + entity.Id);
