...
const dao = require("codbex-hermes/gen/dao/entities/SalesOrder");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/SalesOrder.js/" + entity.Id);
