...
const dao = require("codbex-hermes/gen/dao/entities/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/QuotationStatus.js/" + entity.Id);
