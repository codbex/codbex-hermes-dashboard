...
const dao = require("codbex-hermes/gen/dao/entities/OpportunityNote");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/OpportunityNote.js/" + entity.Id);
