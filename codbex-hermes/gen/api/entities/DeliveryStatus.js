...
const dao = require("codbex-hermes/gen/dao/entities/DeliveryStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/DeliveryStatus.js/" + entity.Id);
