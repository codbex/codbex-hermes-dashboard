...
const dao = require("codbex-hermes/gen/dao/entities/OpportunityProbability");
const http = require("codbex-hermes/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/OpportunityProbability.js/" + entity.Id);
