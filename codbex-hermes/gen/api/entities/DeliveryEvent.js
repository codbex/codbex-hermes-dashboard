...
const dao = require("codbex-hermes/gen/dao/entities/DeliveryEvent");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/DeliveryEvent.js/" + entity.Id);
