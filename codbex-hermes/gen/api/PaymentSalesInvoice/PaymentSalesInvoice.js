...
const dao = require("codbex-hermes/gen/dao/PaymentSalesInvoice/PaymentSalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/PaymentSalesInvoice.js/" + entity.Id);
