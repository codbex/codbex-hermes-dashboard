...
const dao = require("codbex-hermes/gen/dao/QuestinItem/QuotationItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/QuotationItem.js/" + entity.Id);
