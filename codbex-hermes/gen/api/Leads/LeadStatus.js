...
var dao = require("codbex-hermes/gen/dao/Leads/LeadStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/LeadStatus.js/" + entity.Id);
