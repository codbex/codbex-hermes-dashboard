...
const dao = require("codbex-hermes/gen/dao/Opportunity/Opportunity");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-hermes/gen/api/Opportunity.js/" + entity.Id);
