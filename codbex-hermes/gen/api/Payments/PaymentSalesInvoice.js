...
var dao = require("codbex-hermes/gen/dao/Payments/PaymentSalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/PaymentSalesInvoice.js/" + entity.Id);
