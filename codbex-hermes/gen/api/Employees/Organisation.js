...
var dao = require("codbex-hermes/gen/dao/Employees/Organisation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/Organisation.js/" + entity.Id);
