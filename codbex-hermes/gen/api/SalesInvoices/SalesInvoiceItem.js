...
var dao = require("codbex-hermes/gen/dao/SalesInvoices/SalesInvoiceItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/SalesInvoiceItem.js/" + entity.Id);
