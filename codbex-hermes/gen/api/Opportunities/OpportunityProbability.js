...
var dao = require("codbex-hermes/gen/dao/Opportunities/OpportunityProbability");
var http = require("codbex-hermes/gen/api/utils/http");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("OpportunityProbability not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-hermes/gen/api/OpportunityProbability.js/" + entity.Id);
