...
var dao = require("codbex-sales/gen/dao/SalesOrders/SalesOrderItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/SalesOrderItem.js/" + entity.Id);
