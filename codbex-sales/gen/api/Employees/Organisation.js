...
var dao = require("codbex-sales/gen/dao/Employees/Organisation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/Organisation.js/" + entity.Id);
