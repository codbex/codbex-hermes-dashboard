...
var dao = require("codbex-sales/gen/dao/Payments/PaymentSalesInvoice");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/PaymentSalesInvoice.js/" + entity.Id);
