...
var dao = require("codbex-sales/gen/dao/Products/ProductGroup");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/ProductGroup.js/" + entity.Id);
