...
var dao = require("codbex-sales/gen/dao/Quotations/QuotationStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/QuotationStatus.js/" + entity.Id);
