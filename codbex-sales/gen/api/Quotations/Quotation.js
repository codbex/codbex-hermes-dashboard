...
var dao = require("codbex-sales/gen/dao/Quotations/Quotation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/Quotation.js/" + entity.Id);
