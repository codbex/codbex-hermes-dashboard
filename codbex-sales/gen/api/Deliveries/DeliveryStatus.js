...
var dao = require("codbex-sales/gen/dao/Deliveries/DeliveryStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/DeliveryStatus.js/" + entity.Id);
