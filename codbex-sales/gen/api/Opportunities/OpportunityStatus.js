...
var dao = require("codbex-sales/gen/dao/Opportunities/OpportunityStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/OpportunityStatus.js/" + entity.Id);
