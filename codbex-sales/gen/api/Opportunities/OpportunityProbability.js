...
var dao = require("codbex-sales/gen/dao/Opportunities/OpportunityProbability");
var http = require("codbex-sales/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/OpportunityProbability.js/" + entity.Id);
