...
var dao = require("codbex-sales/gen/dao/Opportunities/OpportunityNote");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/codbex-sales/gen/api/OpportunityNote.js/" + entity.Id);
