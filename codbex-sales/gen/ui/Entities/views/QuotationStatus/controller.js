...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Entities.QuotationStatus.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Entities.QuotationStatus.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Entities/QuotationStatus.js';
