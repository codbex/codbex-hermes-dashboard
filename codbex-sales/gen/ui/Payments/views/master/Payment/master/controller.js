...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Payments.Payment.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Payments.Payment.refresh', callback);
		},
		onCurrencyModified: function(callback) {
			on('codbex-sales.Payments.Currency.modified', callback);
		},
		onCustomerModified: function(callback) {
			on('codbex-sales.Payments.Customer.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Payments/Payment.js';
