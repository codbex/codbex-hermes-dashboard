...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Payments.PaymentSalesInvoice.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Payments.PaymentSalesInvoice.refresh', callback);
		},
		onPaymentModified: function(callback) {
			on('codbex-sales.Payments.Payment.modified', callback);
		},
		onSalesInvoiceModified: function(callback) {
			on('codbex-sales.Payments.SalesInvoice.modified', callback);
		},
		onPaymentSelected: function(callback) {
			on('codbex-sales.Payments.Payment.selected', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Payments/PaymentSalesInvoice.js';
	var paymentOptionsApi = '/services/v4/js/codbex-sales/gen/api/Payments/Payment.js';
	var salesinvoiceOptionsApi = '/services/v4/js/codbex-sales/gen/api/SalesInvoices/SalesInvoice.js';
