...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Employees.Employee.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Employees.Employee.refresh', callback);
		},
		onOrganisationModified: function(callback) {
			on('codbex-sales.Employees.Organisation.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Employees/Employee.js';
	var organisationOptionsApi = '/services/v4/js/codbex-sales/gen/api/Employees/Organisation.js';
