...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.SalesOrders.SalesOrder.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.SalesOrders.SalesOrder.refresh', callback);
		},
		onEmployeeModified: function(callback) {
			on('codbex-sales.SalesOrders.Employee.modified', callback);
		},
		onCustomerModified: function(callback) {
			on('codbex-sales.SalesOrders.Customer.modified', callback);
		},
		...
		onQuotationModified: function(callback) {
			on('codbex-sales.SalesOrders.Quotation.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/SalesOrders/SalesOrder.js';
