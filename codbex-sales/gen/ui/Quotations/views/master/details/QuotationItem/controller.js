...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Quotations.QuotationItem.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Quotations.QuotationItem.refresh', callback);
		},
		onQuotationModified: function(callback) {
			on('codbex-sales.Quotations.Quotation.modified', callback);
		},
		onProductModified: function(callback) {
			on('codbex-sales.Quotations.Product.modified', callback);
		},
		onUoMModified: function(callback) {
			on('codbex-sales.Quotations.UoM.modified', callback);
		},
		onCurrencyModified: function(callback) {
			on('codbex-sales.Quotations.Currency.modified', callback);
		},
		onQuotationSelected: function(callback) {
			on('codbex-sales.Quotations.Quotation.selected', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Quotations/QuotationItem.js';
	var quotationOptionsApi = '/services/v4/js/codbex-sales/gen/api/Quotations/Quotation.js';
