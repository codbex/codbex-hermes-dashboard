...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'codbex-sales.Quotations.Quotation.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('codbex-sales.Quotations.Quotation.refresh', callback);
		},
		onEmployeeModified: function(callback) {
			on('codbex-sales.Quotations.Employee.modified', callback);
		},
		onCustomerModified: function(callback) {
			on('codbex-sales.Quotations.Customer.modified', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/codbex-sales/gen/api/Quotations/Quotation.js';
